// https://github.com/PinataCloud/ipfs-gateway-tools/blob/master/src/index.js
import isIPFS from 'is-ipfs'

export const containsCID = (url) => {
...
export const convertToDesiredGateway = (sourceUrl, desiredGatewayPrefix) => {
